...
export default function Home() {
  return (
    <div className="container container--narrow py-md-5">
      <h1 style={{textAlign: "center", padding: 20, fontSize: 60, color: "#058a96"}}>Welcome to UK Tours</h1>
      <div>
        <div className="img-container">
          <img src="https://images.unsplash.com/photo-1546889645-c1ac9128578f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80" alt="city tour" />
        </div>
      </div>
      <div>
        <p className="lead text-muted" style={{padding: 20, textAlign: "left", align: "justify"}} >Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis dolorum labore quisquam vel id dicta fuga! Ducimus, quo. Dolore commodi aliquid error veritatis consequuntur, excepturi cumque fuga eum incidunt doloremque?</p>
